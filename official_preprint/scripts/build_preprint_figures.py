...
def overview_claim():
    ...
    ax_design.axis("off")
    ax_design.set_title("A. Paired trace intervention", loc="left", fontweight="regular")
    rounded_box(
        ax_design,
        (0.03, 0.46),
        0.23,
    ...
    ax_curve.set_title("B. Formal traces extrapolate farther", loc="left", fontweight="regular")
