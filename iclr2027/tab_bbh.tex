\begin{table}[H]
\caption{BIG-Bench Hard resolved by subtask, accuracy in percent. ``Chain'' pools the 8 subtasks whose answer follows from propagating a truth value or a state along a sequence of steps and ``others'' pools the remaining 19.}
\label{tab:bbh}
\begin{center}
