...
conditioned form at 2, 5 and 10 percent, on Dolci and on the same base model as
...
FOLIO, and at the matched share of 10 percent it is 4.0 points below it at
inference depth 3 and 2.0 points below it on FOLIO.
...
100 percent in both renderings and at all three shares. At 2 and 5 percent
they write almost no accepted derivation when neither instruction is present,
at 20.0 and 15.0 percent, while at 10 percent they write one at 99.0 percent,
so the instruction is required for the notation and not for the derivation
itself. The plain model at 2 percent writes an accepted derivation when it is
